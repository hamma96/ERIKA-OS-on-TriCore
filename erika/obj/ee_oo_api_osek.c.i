# 1 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
# 1 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
# 53 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
...
# 54 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c" 2
# 63 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
void
  DisableAllInterrupts
(
  void
...
# 294 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
    p_ccb->os_status = OSEE_KERNEL_STARTING;
    p_ccb->app_mode = real_mode;
# 306 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
    if (
...
# 325 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
...
# 390 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
    {
      MemSize i;
...
# 416 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
...
# 508 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
    osEE_hal_sync_barrier(p_kdb->p_barrier, &p_kcb->ar_core_mask,
      ((void *)0));
    ...
    for(;;) {}
# 564 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  }
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 647 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 728 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  ...
  if (!osEE_is_valid_tid(p_kdb, TaskID)) {
    ...
    OsEE_TDB * const
      p_tdb_act = (*p_kdb->p_tdb_ptr_array)[TaskID];
# 763 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
    if (p_tdb_act->task_type <= OSEE_TASK_TYPE_EXTENDED) {
      OsEE_reg flags;
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 860 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if ((p_curr->task_type > OSEE_TASK_TYPE_EXTENDED)
...
# 890 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  {
    OsEE_reg flags;
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 969 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if ((p_curr->task_type > OSEE_TASK_TYPE_EXTENDED)
...
# 995 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
...
# 1252 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
StatusType
  ShutdownOS
(
  StatusType Error
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1294 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1361 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if (TaskID == ((void *)0)) {
    ...
    OsEE_TDB * const
      p_tdb = p_ccb->p_curr;
# 1377 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1467 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if (State == ((void *)0)) {
    ev = E_OS_PARAM_POINTER;
  } else
  if (!osEE_is_valid_tid(p_kdb, TaskID)) {
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1562 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1653 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_alarm_id(p_kdb, AlarmID)) {
    ev = E_OS_ID;
  } else
  {
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1741 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_alarm_id(p_kdb, AlarmID)) {
    ev = E_OS_ID;
  } else {
    OsEE_AlarmDB * const
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1812 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_alarm_id(p_kdb, AlarmID)) {
    ev = E_OS_ID;
  } else
  if (Tick == ((void *)0)) {
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1888 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_alarm_id(p_kdb, AlarmID)) {
    ev = E_OS_ID;
  } else
  if (Info == ((void *)0)) {
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 1961 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
...
# 1989 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if (p_curr->task_type != OSEE_TASK_TYPE_EXTENDED) {
    ev = E_OS_ACCESS;
  } else
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 2067 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if (osEE_check_disableint(p_ccb)) {
    ev = E_OS_DISABLEDINT;
  } else
...
# 2087 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_tid(p_kdb, TaskID)) {
    ev = E_OS_ID;
  } else {
    OsEE_SN *
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 2164 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if (osEE_check_disableint(p_ccb)) {
    ev = E_OS_DISABLEDINT;
  } else
  if ((p_curr->task_type > OSEE_TASK_TYPE_ISR2)
...
# 2186 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_tid(p_kdb, TaskID)) {
    ev = E_OS_ID;
  } else
  {
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 2266 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if (osEE_check_disableint(p_ccb)) {
    ev = E_OS_DISABLEDINT;
  } else
  if ((p_curr->task_type >= OSEE_TASK_TYPE_ISR2)
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 2349 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  ...
  } else
  {
    ...
    {
# 2382 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 2449 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_counter_id(p_kdb, CounterID)) {
    ev = E_OS_ID;
  } else
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 2567 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_counter_id(p_kdb, CounterID)) {
    ev = E_OS_ID;
  } else
  {
    ...
    {
# 2592 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
      OsEE_reg const flags = osEE_begin_primitive();
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 2672 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  ...
  } else
  {
    ...
    OsEE_reg const
      flags = osEE_begin_primitive();
# 2695 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
    ...
    {
      ev = E_OS_VALUE;
    } else if (osEE_st_get_cb(p_st_db)->st_status != (0x00U))
    {
      ev = E_OS_STATE;
    } else

    {
# 2715 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 2782 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_st_id(p_kdb, ScheduleTableID)) {
    ev = E_OS_ID;
  } else
  {
    ...
    {
# 2820 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
...
)
{
 StatusType ev;
  ...
  osEE_stack_monitoring(p_cdb);
# 2886 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_st_id(p_kdb, ScheduleTableID)) {
    ev = E_OS_ID;
  } else {
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 2964 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_st_id(p_kdb, ScheduleTableID)) {
    ev = E_OS_ID;
  } else
  if (ScheduleStatus == ((void *)0)) {
    ev = E_OS_PARAM_POINTER;
  } else
  {
    OsEE_SchedTabDB * const
...
# 3002 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 3073 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
...
# 3111 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
    ...
    if ((p_from_st_cb->st_status == (0x00U)) ||
      (p_from_st_cb->st_status == (0x01U)))
    {
      ev = E_OS_NOFUNC;
    } else
    if (p_to_st_cb->st_status != (0x00U)) {
      ev = E_OS_STATE;
    } else

    {
# 3150 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
      if (p_from_st_cb->p_next_table != ((void *)0)) {
...
)
{
  ...
  osEE_stack_monitoring(p_cdb);
# 3225 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if (!osEE_is_valid_st_id(p_kdb, ScheduleTableID))
  {
    ev = E_OS_ID;
  } else
  {
    ...
    OsEE_reg const
      flags = osEE_begin_primitive();
# 3250 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
    ...
    if (Value >= p_st_db->duration ) {
      ...
      (osEE_st_get_cb(p_st_db)->st_status == (0x01U))
    )
    {
      ev = E_OS_STATE;
    } else
...
)
{
  ...
  if (CoreID < OS_CORE_ID_ARR_SIZE) {
    ...
    {
# 3366 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
      ev = E_OS_STATE;
    } else {
...
# 3512 "C:\\Users\\PC\\ECLIPS~2\\DEMO_E~2\\erika\\src\\ee_oo_api_osek.c"
  if ((os_status == OSEE_KERNEL_STARTED) || (os_status == OSEE_KERNEL_STARTING))
  {
    CoreNumType i;
    OsEE_KDB * const
